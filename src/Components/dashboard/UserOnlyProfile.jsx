                ...
                <div>
                    ...
                    <section className=" ">
                        <div className="   block  relative bg-opacity-50  z-40  ">
                            <div className="relative mx-auto h-full px-4 md:pb-10 sm:max-w-xl md:max-w-full  ">
                                    ...
                                    <div className=" mt-3 lg:mt-20   ">
                                        ...
                                        
                                        {
                                            ...
                                            <img className="w-32 h-32 rounded-full mx-auto" src={filter[0]?.ImageURL} alt="Profile picture" />
                                                <h3 className="mt-8 text-md font-semibold text-black group-hover:text-white ">Agreement accept date: Not Accepted
                                                </h3>

                                                <div className="flex my-3 gap-5 justify-around">
                                                <h3 className=" text-md font-semibold text-black group-hover:text-white ">Floor No: None
                                                </h3>
                                                <h3 className=" text-md font-semibold text-black group-hover:text-white ">Block name: None
                                                </h3>
                                                </div>
                                                <div className="flex my-3 gap-5 justify-around">
                                                <h3 className=" text-md font-semibold text-black group-hover:text-white ">Apartment No: None
                                                </h3>
