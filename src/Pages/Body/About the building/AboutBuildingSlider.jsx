...
const AboutBuildingSlider = () => {
  ...
  return (
    <>
      <section className="pt-20 dark:bg-dark lg:pb-[120px] lg:pt-[120px]">
        <div className="container mx-auto px-6">
          <Swiper slidesPerView={1} ref={sliderRef}>
            <SwiperSlide>
              <h1 className='text-center font-semibold text-2xl mb-3'>The Grand Elysium Tower</h1>
              <SingleTestimonial
                image={slider3}
                
                
               
                details="nveiling the Epitome of Elegance and Innovation Behold, The Grand Elysium Tower, a symphony of design and functionality that stands as a testament to architectural brilliance. Nestled in the heart of the city, this majestic structure transcends the ordinary, embracing a blend of modern aesthetics and timeless sophistication."
                
                
              />
            </SwiperSlide>
            <SwiperSlide>
              <h1 className='text-center font-semibold text-2xl'>Architectural Marvel</h1>
              <SingleTestimonial
                image={slider4}
                details="Designed by visionary architects, every facet of The Grand Elysium Tower is a masterpiece. From its sleek exterior façade to the meticulously crafted interiors, each detail reflects a commitment to excellence. The building seamlessly merges form and function, creating a harmonious environment for residents and visitors alike."
                
              />
            </SwiperSlide>
            <SwiperSlide>
              <h1 className='text-center font-semibold text-2xl'> Luxury Redefined</h1>
              <SingleTestimonial
                image={slider2}
                details="Step into a realm where luxury knows no bounds. The Grand Elysium Tower boasts state-of-the-art amenities that redefine opulence. Indulge in the exquisite comfort of lavish suites, relish the gourmet delights at the rooftop restaurant, and rejuvenate your senses at the spa—every moment spent here is an experience in extravagance."
                
              />
            </SwiperSlide>
            <div className="absolute  left-72 -right-80 z-10 flex items-center justify-center gap-5 sm:bottom-0">
              <div className="prev-arrow cursor-pointer" onClick={handlePrev}>
                <button className="d flex h-[60px] w-[60px] items-center justify-center rounded-full border border-stroke  text-dark transition-all hover:border-transparent hover:drop-shadow-testimonial dark:border-dark-3 dark:bg-dark-2 dark:text-dark dark:hover:drop-shadow-none">
                  <svg
                    width="20"
                    height="21"
                    viewBox="0 0 20 21"
...
export default AboutBuildingSlider;
